    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Ligamos para você</h4>
    ...
    <div class="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-2">
                    <a href="<?= site_url(); ?>">
                        <img src="<?php echo get_template_directory_uri(); ?>/theme/img/logo-a.png" alt=""
                            width="100px">
                    </a>
                </div>
                <div class="col-md-8" align="center">
                    <div class="menu-home">
                        <ul class="menu-footer">
                            <li>
                                <a class="movediv" href="<?php site_url(); ?>/Alternativa Blog">Blog</a>
                            </li>
                            <li>
                                <a class="movediv" href="<?= site_url(); ?>/quem-somos">Sobre</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="http://central.alternativatelecom.net.br/" target="_blank"
                    ...
                    <div class="menu-interno">
                        <ul class="menu-footer">
                            ...
                            <li>
                                <a class="movediv" href="<?= site_url(); ?>/#box-planos">planos</a>
                            </li>
                            <li>
                                <a class="movediv" href="<?= site_url(); ?>/#box-ajuda">ajuda</a>
                            </li>
                            <li>
                                <a class="movediv" href="<?= site_url(); ?>/#box-app" href="">app</a>
                            </li>
                            <li>
                                <a class="movediv" href="<?= site_url(); ?>/#box-contato" href="">fale conosco</a>
                            </li>
                            <li>
                                <a href="http://central.alternativatelecom.net.br/" target="_blank"
                                    title="Central do Assinante">
...
var hash_smartzap = "ZWI0NzRiYzgzMzE0ZTJhNzU4YzUyN2E1ZDM2MTkwN2ZjNGNhNDIzOGEwYjkyMzgyMGRjYzUwOWE2Zjc1ODQ5Yg"
</script>
<script type="text/javascript" src="https://alternativa.smartzap.com.br/webchannel/source/smartzap-web.js"></script>
</body>
